...
public class MediaController extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.expand) {//全屏按钮
            mExpandImg.setVisibility(View.GONE);
            mShrinkImg.setVisibility(View.VISIBLE);
            mMediaControl.onPageTurn();
        } else if (view.getId() == R.id.shrink) {//缩回按钮
            mExpandImg.setVisibility(View.VISIBLE);
